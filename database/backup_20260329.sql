...
\restrict aYL4jlAP3zxhHqFo7nsYw7ZcYWbPj0b4t9ooQmogBVT0DF2ovFugZIxBdJdzyem
...
CREATE TABLE public.loads (
    ...
    pickup_time text,
    pickup_map_url text,
    tier text DEFAULT 'genel'::text NOT NULL
);
...
CREATE TABLE public.payment_transactions (
    ...
    error_message text,
    paynet_session_id text,
    paynet_token_id text,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: plan_configs; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.plan_configs (
    ...
    badge text,
    highlighted text DEFAULT 'false'::text NOT NULL,
    sort_order integer DEFAULT 0 NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    target_role text DEFAULT 'corporate'::text NOT NULL
);
...
--
-- Name: plan_configs_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.plan_configs_id_seq OWNER TO postgres;

--
-- Name: plan_configs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: shipment_events_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.shipment_events_id_seq OWNER TO postgres;

--
-- Name: shipment_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
CREATE TABLE public.subscriptions (
    ...
    paynet_card_owner_id text,
    paynet_subscription_id text,
    card_masked text,
    card_holder text,
...
CREATE TABLE public.users (
    ...
    billing_info text,
    tax_office text,
    driver_license_token text,
    driver_documents text
);
...
--
-- Name: plan_configs id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: shipment_events id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Data for Name: driver_reviews; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.driver_reviews (id, offer_id, driver_id, corporate_id, rating, comment, created_at) FROM stdin;
\.
...
COPY public.invoices (id, user_id, transaction_id, invoice_no, amount, currency, description, filename, original_name, mime_type, file_size, file_data, uploaded_by, uploaded_at) FROM stdin;
\.
...
COPY public.loads (id, title, description, origin, destination, distance, weight, load_type, vehicle_type, pricing_model, price, min_bid, max_bid, status, is_premium, posted_by_id, offers_count, pickup_date, delivery_date, origin_lat, origin_lng, dest_lat, dest_lng, created_at, waypoints, pickup_time, pickup_map_url, tier) FROM stdin;
1	Ankara-İstanbul Genel Yük	Ambalajlı elektronik ürünler, kırılgan değil	Ankara	İstanbul	450	12500	Genel Yük	Tır	fixed	8500	\N	\N	active	t	6	3	2026-03-25 23:08:31.021469+00	2026-03-26 23:08:31.021469+00	39.9334	32.8597	41.0082	28.9784	2026-03-23 23:08:31.021469+00	\N	\N	\N	genel
5	Gaziantep-Ankara İnşaat Malzemeleri	Demir profiller ve çimento	Gaziantep	Ankara	680	18000	İnşaat Malzemesi	Açık Kasa	fixed	7800	\N	\N	active	f	6	0	2026-03-24 23:08:31.021469+00	2026-03-25 23:08:31.021469+00	37.0662	37.3833	39.9334	32.8597	2026-03-23 23:08:31.021469+00	\N	\N	\N	genel
6	Trabzon-İstanbul Kuru Yük	Fındık ürünleri	Trabzon	İstanbul	1100	15000	Kuru Yük	Tenteli TIR	fixed	12000	\N	\N	assigned	t	6	4	2026-03-22 23:08:31.021469+00	2026-03-24 23:08:31.021469+00	41.0027	39.7168	41.0082	28.9784	2026-03-23 23:08:31.021469+00	\N	\N	\N	genel
8	Kayseri-İzmir Mobilya	Hazır mobilya paketleri, 200 kutu	Kayseri	İzmir	780	11000	Mobilya	Perde Kasalı	fixed	9200	\N	\N	completed	f	6	2	2026-03-18 23:08:31.021469+00	2026-03-20 23:08:31.021469+00	38.7312	35.4787	38.4189	27.1287	2026-03-23 23:08:31.021469+00	\N	\N	\N	genel
3	İstanbul-Bursa Soğuk Zincir	Gıda ürünleri, +4°C soğuk zincir gerektirir	İstanbul	Bursa	150	8000	Soğuk Zincir	Frigorifik	fixed	4200	\N	\N	assigned	t	6	1	2026-03-26 23:08:31.021469+00	2026-03-27 23:08:31.021469+00	41.0082	28.9784	40.1885	29.061	2026-03-23 23:08:31.021469+00	\N	\N	\N	genel
9	Test İlan Güncelleme	\N	İstanbul	Ankara	845	10	general	truck	fixed	5000	\N	\N	active	f	\N	0	2026-04-10 00:00:00+00	2026-04-12 00:00:00+00	40.501232	35.860645	39.873238	36.730663	2026-03-26 22:29:58.616746+00	\N	\N	\N	genel
10	Test Güncelleme	\N	İstanbul	Ankara	278	10	general	truck	fixed	5000	\N	\N	active	f	\N	0	2026-04-10 00:00:00+00	2026-04-12 00:00:00+00	38.504295	32.3116	40.516922	33.099037	2026-03-26 22:30:07.22889+00	\N	\N	\N	genel
\.
...
COPY public.otp_codes (id, identifier, identifier_type, code, is_used, expires_at, created_at, sent_via, user_label) FROM stdin;
1	ahmet@logistikco.com	email	398670	t	2026-03-23 23:44:41.242+00	2026-03-23 23:34:41.246001+00	\N	\N
2	ahmet@logistikco.com	email	385925	t	2026-03-24 01:13:58.634+00	2026-03-24 01:03:58.649477+00	\N	\N
3	ahmet@logistikco.com	email	340137	t	2026-03-24 01:14:07.591+00	2026-03-24 01:04:07.597757+00	\N	\N
4	ahmet@logistikco.com	email	212801	t	2026-03-25 01:21:26.118+00	2026-03-25 01:11:26.151587+00	\N	\N
5	ahmet@logistikco.com	email	802857	f	2026-03-25 01:25:40.306+00	2026-03-25 01:15:40.337817+00	\N	\N
6	kvkk_test@example.com	email	209635	f	2026-03-25 02:40:46.703+00	2026-03-25 02:30:46.703883+00	\N	\N
7	navigoaractakip@gmail.com	email	972083	t	2026-03-25 02:58:17.117+00	2026-03-25 02:48:17.119885+00	\N	\N
8	navigoaractakip@gmail.com	email	839273	t	2026-03-25 03:03:01.763+00	2026-03-25 02:53:01.765718+00	\N	\N
9	navigoaractakip@gmail.com	email	568810	t	2026-03-25 03:04:04.544+00	2026-03-25 02:54:04.54693+00	\N	\N
10	navigoaractakip@gmail.com	email	780334	t	2026-03-25 03:04:13.69+00	2026-03-25 02:54:13.695711+00	\N	\N
11	navigoaractakip@gmail.com	email	263960	t	2026-03-25 03:20:57.847+00	2026-03-25 03:10:57.850299+00	\N	\N
12	navigoaractakip@gmail.com	email	358189	t	2026-03-25 03:22:12.656+00	2026-03-25 03:12:12.658202+00	\N	\N
13	navigoaractakip@gmail.com	email	673260	t	2026-03-25 03:23:11.676+00	2026-03-25 03:13:11.679124+00	\N	\N
14	navigoaractakip@gmail.com	email	623969	t	2026-03-25 03:24:16.754+00	2026-03-25 03:14:16.756996+00	\N	\N
15	navigoaractakip@gmail.com	email	721559	t	2026-03-25 03:24:25.154+00	2026-03-25 03:14:25.158671+00	\N	\N
16	navigoaractakip@gmail.com	email	537825	t	2026-03-25 03:29:29.025+00	2026-03-25 03:19:29.028099+00	\N	\N
17	navigoaractakip@gmail.com	email	724452	t	2026-03-25 03:29:43.359+00	2026-03-25 03:19:43.362939+00	\N	\N
18	navigoaractakip@gmail.com	email	646738	t	2026-03-25 03:31:06.924+00	2026-03-25 03:21:06.926546+00	\N	\N
19	navigoaractakip@gmail.com	email	435003	t	2026-03-25 03:31:20.146+00	2026-03-25 03:21:20.15141+00	\N	\N
20	navigoaractakip@gmail.com	email	238933	t	2026-03-25 03:55:13.45+00	2026-03-25 03:45:13.452789+00	\N	\N
21	navigoaractakip@gmail.com	email	117044	t	2026-03-25 03:55:29.562+00	2026-03-25 03:45:29.566693+00	\N	\N
22	navigoaractakip@gmail.com	email	464988	t	2026-03-25 04:00:12.479+00	2026-03-25 03:50:12.481078+00	\N	\N
23	navigoaractakip@gmail.com	email	132084	t	2026-03-25 04:00:23.079+00	2026-03-25 03:50:23.084239+00	\N	\N
24	navigoaractakip@gmail.com	email	565203	t	2026-03-25 04:15:17.264+00	2026-03-25 04:05:17.267169+00	\N	\N
25	navigoaractakip@gmail.com	email	782124	f	2026-03-25 04:15:40.39+00	2026-03-25 04:05:40.394589+00	\N	\N
\.
...
COPY public.payment_transactions (id, user_id, subscription_id, reference_no, paynet_transaction_id, amount, currency, status, type, plan, description, card_masked, card_holder, bank_name, authorization_code, error_message, paynet_session_id, paynet_token_id, created_at) FROM stdin;
\.


--
-- Data for Name: plan_configs; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.plan_configs (id, plan_id, name, price, currency, features, badge, highlighted, sort_order, updated_at, target_role) FROM stdin;
1	starter	Başlangıç	0	TRY	["Aylık 5 ilan","Temel destek","1 kullanıcı","Standart listeleme"]	\N	false	0	2026-03-29 00:37:07.968198+00	corporate
2	corporate	Kurumsal	4999	TRY	["Sınırsız ilan","Öncelikli destek","5 kullanıcı","Öne çıkan listeleme","Gelişmiş analitik","API erişimi"]	Çok Tercih Edilen	true	1	2026-03-29 00:37:07.968198+00	corporate
3	premium	Premium	9999	TRY	["Sınırsız ilan","7/24 özel destek","Sınırsız kullanıcı","Öne çıkan listeleme","Gelişmiş analitik","API erişimi","Özel entegrasyon","Hesap yöneticisi"]	En Kapsamlı	false	2	2026-03-29 00:37:07.968198+00	corporate
\.
...
14	platform_logo_light	\N	Platform Logosu (Açık)	Koyu/renkli arka planlarda kullanılan açık renkli logo (base64 resim)	platform	f	2026-03-27 23:34:16.855229+00
15	paynet_secret_key	\N	Paynet Secret Key	Paynet API Secret Key (Hesabım → Firma Bilgileri → Entegrasyon Bilgileri)	paynet	t	2026-03-28 23:01:22.813589+00
16	paynet_merchant_id	\N	Paynet Bayi Kodu	Paynet Bayi Kodu (Hesabım → Firma Bilgileri)	paynet	t	2026-03-28 23:01:22.816981+00
17	paynet_ratio_code	\N	Paynet Oran Kodu	Taksit/komisyon oran kodu (Hesabım → Oran alanından oluşturun)	paynet	f	2026-03-28 23:01:22.820956+00
18	paynet_base_url	\N	Paynet API URL	Paynet API temel URL (varsayılan: https://api.paynet.com.tr)	paynet	f	2026-03-28 23:01:22.823803+00
\.
...
5	3	pickup	Teklif kabul edildi. Şoför yükleme noktasına yönlendiriliyor.	\N	\N	2026-03-26 02:48:46.82524+00
6	3	assigned	Sefer atandı - yükleme noktasına yönlendirildi.	\N	\N	2026-03-26 03:43:21.869386+00
\.
...
3	3	5	pickup	\N	\N	\N	2026-03-26 02:48:39.217967+00
\.
...
COPY public.subscriptions (id, user_id, plan, status, amount, currency, "interval", started_at, expires_at, next_payment_at, cancelled_at, paynet_card_owner_id, paynet_subscription_id, card_masked, card_holder, auto_renew, created_at, updated_at) FROM stdin;
\.
...
COPY public.support_tickets (id, user_id, subject, category, priority, message, status, admin_id, admin_reply, replied_at, created_at, updated_at, target_user_id, load_id, load_title) FROM stdin;
1	1	Test Destek Talebi	technical	high	Platform üzerinde teknik bir sorun yaşıyorum, yardım ihtiyacım var.	resolved	1	Sorununuz incelendi. Teknik ekibimiz en kısa sürede size dönecektir.	2026-03-25 03:51:55.246+00	2026-03-25 03:51:06.279287+00	2026-03-25 03:51:55.246+00	\N	\N	\N
\.
...
COPY public.users (id, name, email, phone, role, status, company, avatar_url, rating, total_shipments, created_at, website, address, tax_number, vehicle_types, notification_settings, vehicle_plate, is_phone_verified, billing_info, tax_office, driver_license_token, driver_documents) FROM stdin;
4	Hasan Demir	hasan@driver.com	+90 535 444 5566	driver	active	\N	\N	4.2	56	2026-03-23 23:08:05.467965+00	\N	\N	\N	\N	\N	\N	f	\N	\N	\N	\N
5	Fatma Şahin	fatma@driver.com	+90 536 555 6677	driver	active	\N	\N	4.9	214	2026-03-23 23:08:05.467965+00	\N	\N	\N	\N	\N	\N	f	\N	\N	\N	\N
8	Orhan Tekstil A.Ş.	lojistik@orhantekstil.com	+90 212 567 8901	corporate	pending	Orhan Tekstil A.Ş.	\N	4.3	98	2026-03-23 23:08:05.467965+00	\N	\N	\N	\N	\N	\N	f	\N	\N	\N	\N
9	Yusuf Taşıma	yusuf@tasima.com	+90 537 666 7788	individual	active	\N	\N	4.1	34	2026-03-23 23:08:05.467965+00	\N	\N	\N	\N	\N	\N	f	\N	\N	\N	\N
10	Zeynep Kargo	zeynep@kargo.com	+90 538 777 8899	individual	pending	\N	\N	0	0	2026-03-23 23:08:05.467965+00	\N	\N	\N	\N	\N	\N	f	\N	\N	\N	\N
11	Test Kullanici	kvkk_test@example.com	\N	driver	active	\N	\N	5	0	2026-03-25 02:30:46.66298+00	\N	\N	\N	\N	\N	\N	f	\N	\N	\N	\N
1	Ahmet Çelik	navigoaractakip@gmail.com	+90 532 111 2233	admin	active	TaşıYo A.Ş.	\N	5	0	2026-03-23 23:08:05.467965+00	www.tasiyo.com	Istanbul Kadikoy	1234567890	["Tir","Kamyon"]	{"newOffer":true}	\N	f	\N	\N	\N	\N
\.
...
--
-- Name: driver_reviews_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.driver_reviews_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.loads_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.otp_codes_id_seq', 26, true);
...
--
-- Name: plan_configs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
SELECT pg_catalog.setval('public.platform_settings_id_seq', 18, true);


--
-- Name: shipment_events_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.shipment_events_id_seq', 6, true);
...
--
-- Name: contracts contracts_key_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: plan_configs plan_configs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: plan_configs plan_configs_plan_id_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.plan_configs
    ADD CONSTRAINT plan_configs_plan_id_unique UNIQUE (plan_id);
...
--
-- Name: user_consents user_consents_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict aYL4jlAP3zxhHqFo7nsYw7ZcYWbPj0b4t9ooQmogBVT0DF2ovFugZIxBdJdzyem
